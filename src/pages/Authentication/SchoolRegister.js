...
const optionGroup = [
	{
		label: "Type",
		options: [
			{ label: "Dental Assistant", value: "A" },
			{ label: "Medical Assistant", value: "B" },
			{ label: "Dental Specialty Office", value: "C" },
			{ label: "Diagnostic X-Ray", value: "D" },
			{ label: "Dental Hygiene", value: "E" },
			{ label: "Pharmacy Technician", value: "F" },
			{ label: "Massage Therapy", value: "G" },
			{ label: "Medical Billing & Coding", value: "H" },
			{ label: "Surgical Technology", value: "I" },
                ...
                <div className="page">
                    ...
                    <Modal
                        ...
                        <Row>
                            <Col lg="12">
                                <FormGroup>
                                    <Label for="basicpill-firstname-input14">New Program</Label>
                        ...
                        <Row>
                            <Col lg="12">
                                <Card>
                                    <CardBody>
                                        <h4 className="card-title mb-4">Register School</h4>
                                        ...
                                        <div id="progrss-wizard" className="twitter-bs-wizard">
                                            <ul className="twitter-bs-wizard-nav nav-justified nav nav-pills">
                                                ...
                                                <NavItem>
                                                    ...
                                                    <span className="step-title">School Details</span>
                                                    </NavLink>
                                                </NavItem>
                                            </ul>
                                                ...
                                                <TabPane tabId={3}>
                                                    <Form>
                                                            <Row>
                                                                <Col lg="6">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-firstname-input1">School Name</Label>
                                                                        <Input type="text" className="form-control" id="basicpill-firstname-input1"/>
                                                                    </FormGroup>
                                                                </Col>
                                                                <Col lg="6">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-lastname-input2">School Address</Label>
                                                            ...
                                                            <Row>
                                                                <Col lg="6">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-firstname-input1">School Contact Name</Label>
                                                                        <Input type="text" className="form-control" id="basicpill-firstname-input1"/>
                                                                    </FormGroup>
                                                                </Col>
                                                                <Col lg="6">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-lastname-input2">School Telephone</Label>
                                                                        <Input type="text" className="form-control" id="basicpill-lastname-input2"/>
                                                                    </FormGroup>
                                                                </Col>
                                                            </Row>
                                                            ...
                                                            <Row>
                                                                <Col lg="6">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-lastname-input2">School Fax</Label>
                                                                        <Input type="text" className="form-control" id="basicpill-lastname-input2"/>
                                                                    </FormGroup>
                                                                </Col>
                                                                <Col lg="6">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-phoneno-input3">School Email</Label>
                                                            ...
                                                            <Row>
                                                                <Col lg="12">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-address-input1">Tell us about your school</Label>
                                                            ...
                                                            <Row>
                                                                <Col lg="6">
                                                                    <FormGroup>
                                                                        <Label for="basicpill-email-input4">School Program Offered</Label>
                                                                        <Select
                                                                            value={selectedGroup}
                                                                ...
                                                                <Col lg="6">
                                                                  <FormGroup>
                                                                      <Label for="basicpill-card-verification-input26">School Hours of Operation</Label>
